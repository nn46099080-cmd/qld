...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String get minus20ActionText =>
      '전체 현금의 1%를 기준으로 매주 한 번 TQQQ를 분할 매수합니다. 한 번에 큰돈을 넣는 전략이 아니라, 횡보·하락 구간에서 천천히 수량을 모으는 방식입니다.';
  ...
  String get minus20BuyRuleText =>
      '-20% 구간부터 적립을 시작하는 이유는 횡보장이 길어지거나 추가 하락이 이어질 때도 TQQQ 평균단가를 천천히 낮추기 위해서입니다. 핵심은 단기 수익을 맞히는 것이 아니라 낮은 평균단가를 꾸준히 만드는 것입니다.';
  ...
  String get minus20CashText =>
      '대부분의 현금은 -30%, -40%, -50% 구간을 위해 남깁니다. -50% 이상 하락 후 계획 현금을 모두 소진했더라도, 월급 등 새 소득이 생기면 그 현금으로 매주 1%씩 추가 분할 매수를 이어갑니다.';
  ...
  String get minus20AvoidText =>
      '모아가는 TQQQ는 작은 반등마다 정리하지 않습니다. QLD가 전고점을 돌파하면 TQQQ 모으기를 멈추고, TQQQ를 정리해 다시 QLD 70%와 현금 30% 구조로 리밸런싱합니다.';
  ...
  String get minus50AfterText =>
      '-50% 이상 하락 후 남은 현금을 모두 사용했더라도 전략이 끝난 것은 아닙니다. 이후 월급이나 사업소득처럼 새 현금흐름이 생기면 매주 1%씩 TQQQ를 분할 매수해 평균단가를 계속 낮춥니다.';
  ...
  String get minus50AvoidText =>
      '손실률만 보고 포기하지 않습니다. 다만 빚이나 단기 생활자금으로 추가 매수하지 않습니다. 새 소득 범위 안에서만 모으고, QLD 전고점 돌파 시 TQQQ를 정리해 QLD 70%와 현금 30%로 돌아갑니다.';
